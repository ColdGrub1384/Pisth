...
open class CodeAttributedString : NSTextStorage
{
    ...
    {
        return stringStorage.attributes(at: location, effectiveRange: range) as! [String : Any]
    }
    ...
    {
        stringStorage.setAttributes(attrs as! [NSAttributedStringKey : Any]?, range: range)
